...
import com.hanserdev.interview.config.jackson.YearMonthFlexibleDeserializer;
import com.hanserdev.interview.constants.DateConstants;
import com.hanserdev.interview.utils.JsonUtils;
...
public class CustomJacksonConfiguration {
    ...
    public ObjectMapper objectMapper() {
        ...
        javaTimeModule.addDeserializer(YearMonth.class, new YearMonthFlexibleDeserializer());
