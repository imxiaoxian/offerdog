...
public class UserResumeRspVO {
     ...
     */
    @Valid
    private UserResumeDTO.Location location;

    /**
     * 教育背景信息列表
     */
    @Valid
    private List<UserResumeDTO.Education> education;

    /**
     * 联系方式信息
     */
    @Valid
    private UserResumeDTO.Contact contact;

    /**
     * 工作经历信息
     */
    @Valid
    private UserResumeDTO.Work work;
    ...
    public static class Work {
         ...
         */
        @Valid
        private List<UserResumeDTO.WorkExperience> experience;

        /**
         * 项目经历列表
         */
        @Valid
        private List<UserResumeDTO.ProjectExperience> projects;
    }
